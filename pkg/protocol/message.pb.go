...
type Message struct {
	...
	ContentType  int32  `protobuf:"varint,6,opt,name=contentType,proto3" json:"contentType,omitempty"` // 1-> text , 2 -> pdf files etc , 3 -> pic , 4 -> audio , 5 -> video , 6-> voice call , 7 -> video call
	Type         string `protobuf:"bytes,7,opt,name=type,proto3" json:"type,omitempty"`
	MessageType  int32  `protobuf:"varint,8,opt,name=messageType,proto3" json:"messageType,omitempty"` // 1 -> private message , 2- > group message
	Url          string `protobuf:"bytes,9,opt,name=url,proto3" json:"url,omitempty"`                  // url for video , picture or audio
...
var file_message_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x03, 0x5a,
